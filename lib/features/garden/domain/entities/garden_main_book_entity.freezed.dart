...
mixin _$GardenMainBookEntity {
 ...
 int get bookNo; String get bookTitle; String get bookAuthor; String get bookImageUrl; String get bookTree; double get percent;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,bookNo,bookTitle,bookAuthor,bookImageUrl,bookTree,percent);

@override
String toString() {
  return 'GardenMainBookEntity(bookNo: $bookNo, bookTitle: $bookTitle, bookAuthor: $bookAuthor, bookImageUrl: $bookImageUrl, bookTree: $bookTree, percent: $percent)';
}
...
@useResult
$Res call({
 int bookNo, String bookTitle, String bookAuthor, String bookImageUrl, String bookTree, double percent
});
...
/// Create a copy of GardenMainBookEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bookNo = null,Object? bookTitle = null,Object? bookAuthor = null,Object? bookImageUrl = null,Object? bookTree = null,Object? percent = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int bookNo,  String bookTitle,  String bookAuthor,  String bookImageUrl,  String bookTree,  double percent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GardenMainBookEntity() when $default != null:
return $default(_that.bookNo,_that.bookTitle,_that.bookAuthor,_that.bookImageUrl,_that.bookTree,_that.percent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int bookNo,  String bookTitle,  String bookAuthor,  String bookImageUrl,  String bookTree,  double percent)  $default,) {final _that = this;
switch (_that) {
case _GardenMainBookEntity():
return $default(_that.bookNo,_that.bookTitle,_that.bookAuthor,_that.bookImageUrl,_that.bookTree,_that.percent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int bookNo,  String bookTitle,  String bookAuthor,  String bookImageUrl,  String bookTree,  double percent)?  $default,) {final _that = this;
switch (_that) {
case _GardenMainBookEntity() when $default != null:
return $default(_that.bookNo,_that.bookTitle,_that.bookAuthor,_that.bookImageUrl,_that.bookTree,_that.percent);case _:
  return null;
...
class _GardenMainBookEntity implements GardenMainBookEntity {
  const _GardenMainBookEntity({this.bookNo = 0, this.bookTitle = '', this.bookAuthor = '', this.bookImageUrl = '', this.bookTree = '', this.percent = 0});
...
/// Create a copy of GardenMainBookEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bookNo = null,Object? bookTitle = null,Object? bookAuthor = null,Object? bookImageUrl = null,Object? bookTree = null,Object? percent = null,}) {
